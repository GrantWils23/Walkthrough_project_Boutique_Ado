...
class Order(models.Model):
    ...
    def update_total(self):
        ...
        accounting for delievery costs.
        '''
    ...
    def save(self, *args, **kwargs):
        ...
        number if it hasn't been already set.
        '''
...
class OrderLineItem(models.Model):
    ''' The order line model handles the items in the order '''
    order = models.ForeignKey(Order, null=False, blank=False, on_delete=models.CASCADE, related_name='lineitems')
    product = models.ForeignKey(Product, null=False, blank=False, on_delete=models.CASCADE)
    product_size = models.CharField(max_length=2, null=True, blank=True) # XS,S,M,L,LG
    ...
    def __str__(self):
        return f'SKU {product.sku} on order {self.order.order_number}'
